...
open class TextFieldEffects : UITextField {
    ...
    */
    ...
    override open func willMove(toSuperview newSuperview: UIView!) {
       /* if newSuperview != nil {
            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidEndEditing), name: UITextFieldtextDidEndEditingNotification, object: self)
            
            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidBeginEditing), name: UITextFieldtextDidBeginEditingNotification, object: self)
        } else {
